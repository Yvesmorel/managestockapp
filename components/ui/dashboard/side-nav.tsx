...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col items-center px-2 py-2 w-[140px]">
      <div className="font-semibold loginpagegradient  h-[47px] w-full  flex items-center text-black mb-2 relative p-2">
